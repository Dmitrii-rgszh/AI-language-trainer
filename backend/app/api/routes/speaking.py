...
def get_speaking_feedback(payload: SpeakingFeedbackRequest) -> AITextFeedback:
...
def get_speaking_attempts() -> list[SpeakingAttempt]:
    return speaking_service.list_attempts(require_profile().id)
