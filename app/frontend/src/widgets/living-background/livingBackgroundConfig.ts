...
export const livingDepthSectionIds = {
  ...
  routeDailyLoop: "route-daily-loop",
  routeActivity: "route-activity",
  routeListening: "route-listening",
  ...
  dashboardDailyLoop: "dashboard-daily-loop",
  ...
  progressCoach: "progress-coach",
  activityCoach: "activity-coach",
  settingsCoach: "settings-coach",
  lessonResultsCoach: "lesson-results-coach",
...
const routeSectionByPath: Record<string, string> = {
  ...
  [routes.dailyLoop]: livingDepthSectionIds.routeDailyLoop,
  [routes.activity]: livingDepthSectionIds.routeActivity,
  [routes.listening]: livingDepthSectionIds.routeListening,
  [routes.vocabulary]: livingDepthSectionIds.routeVocabulary,
  [routes.reading]: livingDepthSectionIds.routeReading,
...
export const livingDepthSectionBackgroundMap: Record<string, LivingBackgroundId> = {
  ...
  [livingDepthSectionIds.routeDailyLoop]: "background-5",
  [livingDepthSectionIds.routeActivity]: "background-5",
  [livingDepthSectionIds.routeListening]: "background-5",
  [livingDepthSectionIds.routeVocabulary]: "background-4",
  [livingDepthSectionIds.routeReading]: "background-4",
  ...
  [livingDepthSectionIds.dashboardCoach]: "background-2",
  [livingDepthSectionIds.dashboardDailyLoop]: "background-5",
  [livingDepthSectionIds.dashboardHero]: "background-2",
  [livingDepthSectionIds.grammarCoach]: "background-3",
  [livingDepthSectionIds.speakingCoach]: "background-5",
  [livingDepthSectionIds.listeningCoach]: "background-5",
  [livingDepthSectionIds.vocabularyCoach]: "background-4",
  [livingDepthSectionIds.readingCoach]: "background-4",
  [livingDepthSectionIds.pronunciationCoach]: "background-6",
  [livingDepthSectionIds.writingCoach]: "background-7",
  [livingDepthSectionIds.progressCoach]: "background-4",
  [livingDepthSectionIds.activityCoach]: "background-5",
  [livingDepthSectionIds.settingsCoach]: "background-2",
  [livingDepthSectionIds.lessonResultsCoach]: "background-7",
