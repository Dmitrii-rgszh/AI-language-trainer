...
const translationEntries: TranslationEntry[] = [
  ...
  { en: "Lesson in progress", ru: "Урок в процессе" },
  { en: "Next step", ru: "Следующий шаг" },
  { en: "Today we focus on", ru: "Сегодня работаем вокруг" },
  { en: "After this", ru: "После этого" },
  { en: "After this, I will show the next focused step.", ru: "После этого я покажу следующий сфокусированный шаг." },
  { en: "Plan for today", ru: "План на сегодня" },
  { en: "What happens after this", ru: "Что будет после этого" },
  { en: "What we strengthen next", ru: "Что укрепляем дальше" },
  { en: "Other ways to move forward", ru: "Другие варианты движения" },
  { en: "Alternative step", ru: "Альтернативный шаг" },
  { en: "Route continuity", ru: "Непрерывность маршрута" },
  { en: "Today's route is waiting for you", ru: "Сегодняшний маршрут уже ждёт тебя" },
  { en: "Today's route is complete", ru: "Сегодняшний маршрут завершён" },
  { en: "Tomorrow preview", ru: "Завтрашний шаг" },
  { en: "Practice shift", ru: "Сдвиг практики" },
  { en: "Review the updated route", ru: "Посмотреть обновлённый маршрут" },
  { en: "Open the route trail", ru: "Открыть след маршрута" },
  { en: "What comes next", ru: "Что идёт дальше" },
  { en: "Route flow", ru: "Ход маршрута" },
  { en: "Now", ru: "Сейчас" },
  { en: "Then", ru: "Потом" },
  { en: "Carry", ru: "Дальше с собой" },
  { en: "Session", ru: "Сессия" },
  { en: "Budget", ru: "Время" },
  { en: "Recovery arc", ru: "Восстановительная дуга" },
  { en: "Current route", ru: "Текущий маршрут" },
  { en: "Start today's route", ru: "Начать сегодняшний маршрут" },
  { en: "Resume today’s route", ru: "Продолжить сегодняшний маршрут" },
  { en: "Open route preview", ru: "Открыть обзор маршрута" },
  { en: "Restart gently", ru: "Мягко вернуться" },
  { en: "Continue protected return", ru: "Продолжить защищённое возвращение" },
  { en: "Start repair cycle", ru: "Начать цикл восстановления" },
  { en: "Stabilize the route", ru: "Стабилизировать маршрут" },
  { en: "Keep the rhythm going", ru: "Сохранить ритм" },
  { en: "Return to broader route", ru: "Вернуться к широкому маршруту" },
  { en: "Start recovery", ru: "Начать восстановление" },
  { en: "Start checkpoint", ru: "Начать checkpoint" },
  { en: "The route is rebuilding, so the next click should reopen the habit softly around", ru: "Маршрут сейчас пересобирается, поэтому следующий шаг должен мягко вернуть привычку вокруг" },
  { en: "The route is back in motion, but it should still stay protected around", ru: "Маршрут уже снова движется, но пока ему всё ещё нужна защита вокруг" },
  { en: "before it widens", ru: "прежде чем он снова расширится" },
  { en: "The next route should keep returning to", ru: "Следующий маршрут должен осознанно возвращаться к" },
  { en: "on purpose across several sessions", ru: "через несколько сессий подряд" },
  { en: "The next route should keep", ru: "Следующий маршрут должен удерживать" },
  { en: "protected before it broadens again", ru: "под защитой, прежде чем снова расширяться" },
  { en: "The route can extend forward now, while still protecting", ru: "Маршрут уже может двигаться шире вперёд, всё ещё защищая" },
  { en: "The ritual signal is already stable enough to stay inside the wider route.", ru: "Ритуальный сигнал уже достаточно стабилен, чтобы оставаться внутри более широкого маршрута." },
  { en: "Today's daily route should lead again.", ru: "Теперь основной дневной маршрут снова должен вести первым." },
  { en: "Finish today's loop to unlock the next focused step around", ru: "Заверши сегодняшний цикл, чтобы открыть следующий сфокусированный шаг вокруг" },
  { en: "Supports today’s rhythm", ru: "Поддерживает ритм дня" },
  { en: "Current day shape", ru: "Текущий режим дня" },
  { en: "The system is protecting the main route right now, so side modules should wait until today's return is complete.", ru: "Сейчас система защищает главный маршрут, поэтому боковым модулям лучше подождать, пока сегодняшнее возвращение не завершится." },
  { en: "Dashboard", ru: "Дашборд" },
  { en: "Live Avatar", ru: "Аватар" },
  { en: "Daily Loop", ru: "Ежедневный маршрут" },
  { en: "Activity", ru: "Активность" },
  { en: "Vocabulary", ru: "Словарь" },
  { en: "Reading", ru: "Чтение" },
  { en: "Lesson Runner", ru: "Урок" },
  { en: "Continue lesson", ru: "Продолжаем урок" },
  { en: "Continue from here", ru: "Продолжаешь с того же места" },
  { en: "Now: warm-up before speaking", ru: "Сейчас — разогрев перед разговором" },
  { en: "How this lesson is built", ru: "Как построен этот урок" },
  { en: "Full step plan", ru: "Полный план шага" },
  { en: "This lesson is already part of your connected route", ru: "Этот урок уже встроен в твой маршрут" },
  { en: "Daily ritual", ru: "Ежедневный ритм" },
  { en: "Connected route", ru: "Связанный маршрут" },
  { en: "Current ritual pass", ru: "Текущий проход" },
  { en: "Completion rule", ru: "Как завершается" },
  { en: "Closure rule", ru: "Как закрывается" },
  { en: "After this block", ru: "После этого шага" },
  { en: "Liza will first show the session result, then move the route forward through", ru: "Лиза сначала покажет итог урока, затем поведёт маршрут через" },
  { en: "Liza will first show the session result, then move the route to the next step.", ru: "Лиза сначала покажет итог урока, затем переведёт маршрут к следующему шагу." },
  { en: "Step", ru: "Шаг" },
  { en: "of", ru: "из" },
  { en: "About", ru: "Около" },
  { en: "min", ru: "мин" },
  { en: "Listen and repeat the phrase.", ru: "Послушай и повтори фразу." },
  { en: "Read the prompt and answer shortly.", ru: "Прочитай подсказку и ответь коротко." },
  { en: "Read the phrase and answer shortly.", ru: "Прочитай фразу и ответь коротко." },
  { en: "Listen once, then answer.", ru: "Послушай один раз и ответь." },
  { en: "Read the short text, then answer.", ru: "Прочитай короткий текст и ответь." },
  { en: "Listen and repeat slowly.", ru: "Послушай и повтори не спеша." },
  { en: "Write a short answer.", ru: "Напиши короткий ответ." },
  { en: "Finish with one short note.", ru: "Закончи одной короткой мыслью." },
  { en: "Do this step and continue.", ru: "Сделай шаг и продолжай." },
  { en: "Task", ru: "Задание" },
  { en: "Useful phrases", ru: "Полезные фразы" },
  { en: "Try this", ru: "Попробуй это" },
  { en: "Phrase", ru: "Фраза" },
  { en: "Listen", ru: "Послушать" },
  { en: "Type the translation:", ru: "Введи перевод фразы:" },
  { en: "Write the translation", ru: "Напиши перевод" },
  { en: "Write one short note:", ru: "Напиши одну короткую мысль:" },
  { en: "Write one short note", ru: "Напиши одну короткую мысль" },
  { en: "Write a short answer:", ru: "Напиши короткий ответ:" },
  { en: "Write a short answer", ru: "Напиши короткий ответ" },
  { en: "guided lesson", ru: "урок с сопровождением" },
  { en: "smart re-entry", ru: "мягкое возвращение" },
  { en: "proof-lesson handoff", ru: "переход после первого урока" },
  { en: "onboarding handoff", ru: "переход после регистрации" },
  { en: "route launch", ru: "запуск маршрута" },
  { en: "task-driven handoff", ru: "переход к заданию" },
  { en: "lesson completion", ru: "урок завершён" },
  { en: "draft return", ru: "возврат к уроку" },
  { en: "results follow-up", ru: "следующий шаг после итогов" },
  { en: "results handoff", ru: "переход после итогов" },
  { en: "support step follow-up", ru: "поддерживающий шаг" },
  { en: "Review weak spots", ru: "Повтор полезных фраз" },
  { en: "Present Perfect in professional updates", ru: "Present Perfect в рабочих ответах" },
  { en: "Guided speaking", ru: "Разговорная практика" },
  { en: "Trainer feedback language", ru: "Язык обратной связи" },
  { en: "Summary and next step", ru: "Итог и следующий шаг" },
  { en: "Grammar checkpoint", ru: "Проверка грамматики" },
  { en: "Speaking checkpoint", ru: "Разговорная проверка" },
  { en: "Listening checkpoint", ru: "Проверка аудирования" },
  { en: "Writing checkpoint", ru: "Письменная проверка" },
  { en: "Checkpoint summary", ru: "Итог проверки" },
  { en: "Next", ru: "Далее" },
  { en: "Finish lesson", ru: "Завершить урок" },
  { en: "Other actions", ru: "Другие действия" },
  { en: "Save for later", ru: "Сохранить на потом" },
  { en: "Start over", ru: "Начать заново" },
  { en: "Close lesson", ru: "Закрыть урок" },
  { en: "Hide", ru: "Скрыть" },
  { en: "Hear it again", ru: "Послушать ещё раз" },
  { en: "You are continuing the lesson. Listen first, then do this step.", ru: "Ты продолжаешь урок. Сначала послушай фразу, потом сделай этот шаг." },
  { en: "There is only one next action here: hear the model, understand it, and answer.", ru: "Здесь один следующий шаг: услышать образец, понять его и ответить." },
  { en: "Your progress will stay here if you come back later.", ru: "Прогресс сохранится, если вернёшься позже." },
  { en: "Open the results and move on.", ru: "Открой итог и двигайся дальше." },
  ...
  { en: "Discard draft", ru: "Закрыть незавершённый урок" },
  { en: "Close unfinished lesson", ru: "Закрыть незавершённый урок" },
  ...
  { en: "Everyday English Flow: guided route for grammar", ru: "Повседневный английский: маршрут вокруг грамматики" },
  { en: "Route vocabulary warm-up", ru: "Словарный разогрев маршрута" },
  { en: "Speaking Check-in", ru: "Короткая разговорная практика" },
  { en: "Open activity center", ru: "Открыть центр активности" },
  { en: "See lesson history, speaking attempts, current results and mistake patterns in one place.", ru: "Смотри историю уроков, разговорные попытки, текущие результаты и повторяющиеся ошибки в одном месте." },
  { en: "Короткий guided speaking с фидбеком.", ru: "Короткая разговорная практика с обратной связью." },
  { en: "A short guided speaking session with feedback.", ru: "Короткая разговорная практика с обратной связью." },
  { en: "Short guided speaking with focused feedback before the next full lesson.", ru: "Короткая разговорная практика с точечной обратной связью перед следующим полным уроком." },
  { en: "Short guided speaking keeps the corrected pattern active without forcing a full recovery loop.", ru: "Короткая разговорная практика удерживает исправленный паттерн активным без запуска полного цикла восстановления." },
  { en: "Нужен короткий review + speaking drill на опыт и недавние действия.", ru: "Нужен короткий разбор и разговорная практика на опыт и недавние действия." },
  { en: "Add a short review plus a speaking drill on experience and recent actions.", ru: "Нужен короткий разбор и разговорная практика на опыт и недавние действия." },
  { en: "Feedback language for workshops", ru: "Язык обратной связи для воркшопов" },
  { en: "Повторить мягкие формулировки для фасилитации и coaching.", ru: "Повторить мягкие формулировки для фасилитации и сопровождения." },
  { en: "Present Perfect vs Past Simple", ru: "Present Perfect и Past Simple" },
  { en: "Sound /th/", ru: "Звук /th/" },
  { en: "Everyday English Flow", ru: "Повседневный английский" },
  ...
  { en: "grammar", ru: "грамматика" },
  { en: "route_rebuild", ru: "пересборка маршрута" },
  { en: "min", ru: "мин" },
  { en: "Gentle restart", ru: "Мягкий рестарт" },
  { en: "Compact day", ru: "Компактный день" },
  { en: "Extended day", ru: "Расширенный день" },
  { en: "Standard day", ru: "Обычный день" },
  { en: "building_rhythm", ru: "возвращение ритма" },
  { en: "gentle_restart", ru: "мягкий рестарт" },
  ...
  { en: "English relationship", ru: "Отношения с английским" },
  { en: "How should English feel in the long run?", ru: "Каким английский должен ощущаться в долгой перспективе?" },
  { en: "What makes English feel heavy right now?", ru: "Что делает английский тяжёлым прямо сейчас?" },
  { en: "Which rituals should become part of the route?", ru: "Какие ритуалы должны стать частью маршрута?" },
  { en: "Relationship goal", ru: "Цель по ощущениям" },
  { en: "Emotional barriers", ru: "Эмоциональные барьеры" },
  { en: "Helpful rituals", ru: "Полезные ритуалы" },
  { en: "Freedom and lightness", ru: "Свобода и лёгкость" },
  { en: "Spontaneous speaking", ru: "Спонтанная речь" },
  { en: "Self-expression", ru: "Самовыражение" },
  { en: "Calm confidence", ru: "Спокойная уверенность" },
  { en: "Fear of mistakes", ru: "Страх ошибок" },
  { en: "Fear of judgment", ru: "Страх осуждения" },
  { en: "Perfectionism", ru: "Перфекционизм" },
  { en: "Voice shyness", ru: "Скованность своего голоса" },
  { en: "English feels heavy", ru: "Английский ощущается тяжёлым" },
  { en: "Stress from uncertainty", ru: "Стресс от неопределённости" },
  { en: "Daily word journal", ru: "Ежедневный словарный дневник" },
  { en: "captured", ru: "сохранено" },
  { en: "Failed to save the word journal item.", ru: "Не удалось сохранить запись в словарный дневник." },
  { en: "Reading for pleasure", ru: "Чтение ради удовольствия" },
  { en: "Spontaneous voice notes", ru: "Спонтанные голосовые заметки" },
  { en: "Highlight and lowlight reflection", ru: "Рефлексия лучший и трудный момент" },
  { en: "Playful real-life contact", ru: "Игривый живой контакт" },
  { en: "Gentle daily consistency", ru: "Мягкая ежедневная регулярность" },
  { en: "word_journal", ru: "словарный дневник" },
  { en: "Login", ru: "Логин" },
  ...
  { en: "Dashboard", ru: "Дашборд" },
  { en: "Focus", ru: "Фокус" },
  { en: "Route stage", ru: "Этап маршрута" },
  ...
  { en: "Укрепить Present Perfect и потренировать trainer feedback language.", ru: "Укрепить Present Perfect и потренировать язык обратной связи тренера." },
  { en: "Strengthen Present Perfect and practice trainer feedback language.", ru: "Укрепить Present Perfect и потренировать язык обратной связи тренера." },
  { en: "Нужен короткий review + speaking drill на опыт и недавние действия.", ru: "Нужен короткий разбор и разговорная практика на опыт и недавние действия." },
  { en: "Add a short review plus a speaking drill on experience and recent actions.", ru: "Нужен короткий разбор и разговорная практика на опыт и недавние действия." },
  ...
  { en: "Повторить мягкие формулировки для фасилитации и coaching.", ru: "Повторить мягкие формулировки для фасилитации и сопровождения." },
  { en: "Review softer facilitation and coaching phrasing.", ru: "Повторить мягкие формулировки для фасилитации и сопровождения." },
  ...
  { en: "Lesson progress", ru: "Прогресс урока" },
  { en: "Current step", ru: "Текущий шаг" },
  { en: "Lesson is open", ru: "Урок уже открыт" },
  { en: "You are here", ru: "Сейчас ты здесь" },
  { en: "You are moving", ru: "Ты уже в процессе" },
  { en: "Let's finish", ru: "Давай закончим" },
  { en: "You will continue from this exact place", ru: "Продолжишь с этого же места" },
  { en: "Just a little more", ru: "Осталось совсем немного" },
  { en: "A few steps left", ru: "Осталось несколько шагов" },
  { en: "About 3-4 minutes", ru: "Около 3–4 минут" },
  { en: "About 5-8 minutes", ru: "Около 5–8 минут" },
  { en: "About 10-12 minutes", ru: "Около 10–12 минут" },
  { en: "Already done", ru: "Уже прошёл" },
  { en: "Still ahead", ru: "Осталось" },
  { en: "About time", ru: "По времени" },
  { en: "About", ru: "Около" },
  { en: "min left", ru: "мин осталось" },
  { en: "Almost done", ru: "Почти готово" },
  { en: "Done", ru: "Пройдено" },
  { en: "Left", ru: "Осталось" },
  { en: "Time", ru: "Время" },
  { en: "of", ru: "из" },
  { en: "step", ru: "шаг" },
  { en: "steps", ru: "шагов" },
  { en: "short step", ru: "короткий шаг" },
  { en: "short steps", ru: "коротких шагов" },
  { en: "the next personal step", ru: "следующий личный шаг" },
  { en: "Why finish it now", ru: "Почему важно завершить" },
  { en: "Why now", ru: "Зачем сейчас" },
  { en: "The base of the lesson is forming now", ru: "Ты уже начал — продолжим отсюда" },
  { en: "You are already in the lesson; only a little is left", ru: "Ты уже в процессе — осталось немного" },
  { en: "Final stage; now we secure the result", ru: "Финиш рядом — повторим главное" },
  {
    en: "Close the lesson, keep the rhythm, and unlock the next personal step.",
    ru: "Закрываешь урок → не теряешь ритм → открывается следующий шаг",
  },
  {
    en: "Finish now, and you will not lose the thread. Then I will show the next step.",
    ru: "Закончим сейчас, чтобы не потерять нить.",
  },
  {
    en: "Finishing this lesson keeps the route together and opens the next personal step without losing today's rhythm.",
    ru: "Завершение урока сохранит ход маршрута и откроет следующий личный шаг без потери сегодняшнего ритма.",
  },
  { en: "After the lesson", ru: "После урока" },
  { en: "After you finish", ru: "После урока" },
  {
    en: "a short speaking practice to carry the correction into speech",
    ru: "короткая разговорная практика, чтобы перенести исправление в речь",
  },
  {
    en: "a short calm practice so it moves into speech",
    ru: "короткая спокойная практика, чтобы легче сказать это вслух",
  },
  { en: "we will try saying it out loud", ru: "попробуем сказать это вслух" },
  { en: "Close unfinished lesson", ru: "Закрыть незавершённый урок" },
  { en: "Discard draft", ru: "Закрыть незавершённый урок" },
  { en: "Everyday English Flow: guided route for grammar", ru: "Повседневный английский: маршрут вокруг грамматики" },
  { en: "Everyday English Flow", ru: "Повседневный английский" },
  { en: "Everyday conversation", ru: "повседневный разговор" },
  { en: "Everyday conversation flow", ru: "Повседневная разговорная практика" },
  { en: "Поток everyday conversation", ru: "Повседневная разговорная практика" },
  { en: "Speaking Check-in", ru: "Короткая разговорная практика" },
  { en: "What we will revisit after the lesson", ru: "К чему вернёмся после урока" },
  { en: "What is next", ru: "Что дальше" },
  { en: "topics", ru: "темы" },
  { en: "You can look here later", ru: "Можно посмотреть позже" },
  { en: "These can wait until the lesson is finished.", ru: "Это можно открыть позже, после завершения урока." },
  { en: "Finish the lesson first. Come back to this later.", ru: "Сейчас лучше закончить урок. К этому вернёшься потом." },
  { en: "Better finish the lesson first", ru: "Сейчас лучше закончить урок" },
  { en: "Not for right now", ru: "Не сейчас" },
  { en: "Later, if you want", ru: "Позже, если захочешь" },
  { en: "We will repeat it on a simple example.", ru: "Коротко повторим." },
  { en: "We will repeat it briefly.", ru: "Коротко повторим." },
  { en: "We will try saying it more naturally.", ru: "Попробуем сказать это вслух." },
  { en: "We will try saying it out loud.", ru: "Попробуем сказать это вслух." },
  { en: "We will say it slowly and clearly.", ru: "Скажем медленно и ясно." },
  { en: "A short guided speaking session with feedback.", ru: "Короткая разговорная практика с обратной связью." },
  { en: "Short guided speaking with focused feedback before the next full lesson.", ru: "Короткая разговорная практика с точечной обратной связью перед следующим полным уроком." },
  { en: "Короткий guided speaking с фидбеком.", ru: "Короткая разговорная практика с обратной связью." },
  { en: "Нужен короткий review + speaking drill на опыт и недавние действия.", ru: "Вернёмся к этой теме на простом примере." },
  { en: "Add a short review plus a speaking drill on experience and recent actions.", ru: "Вернёмся к этой теме на простом примере." },
  { en: "Повторить мягкие формулировки для фасилитации и coaching.", ru: "Повторим мягкие фразы, которые легче сказать вслух." },
  { en: "Review softer facilitation and coaching phrasing.", ru: "Повторим мягкие фразы, которые легче сказать вслух." },
  { en: "Open activity center", ru: "Посмотреть историю позже" },
  {
    en: "See lesson history, speaking attempts, current results and mistake patterns in one place.",
    ru: "Туда можно вернуться позже.",
  },
  { en: "Update profile", ru: "Настроить профиль позже" },
  {
    en: "Adjust current level, target, lesson duration and priority mix without leaving the base flow.",
    ru: "Можно поменять уровень и цель. Но не сейчас.",
  },
  {
    en: "See lesson history, speaking attempts, current results and mistake patterns in one place.",
    ru: "Туда можно вернуться позже.",
