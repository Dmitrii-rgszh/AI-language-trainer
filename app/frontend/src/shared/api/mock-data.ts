...
export const mockJourneyState: LearnerJourneyState = {
  ...
  strategySnapshot: {
    ...
    ritualSignalMemory: {
      ...
      completedSinceCapture: 1,
      summary: "The route should reuse keep it light directly inside the response lane once more before the ritual signal broadens.",
      actionHint: "Treat the next route as a connected reuse pass around keep it light.",
      recordedAt: "2026-04-18T08:15:00",
      lastEvaluationAction: "advance_to_reuse",
    },
    learningBlueprint: {
      version: "v1",
